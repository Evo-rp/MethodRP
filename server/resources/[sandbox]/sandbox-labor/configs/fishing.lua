function GetFishingLootForZone(toolUsed, zone)
    ...
    if zone == 1 then
        return {
            {15, { name = "fishing_grasscarp", max = (usingNet and 5 or 1) }, 1},
            {15, { name = "fishing_chub", max = (usingNet and 6 or 1) }, 1, true},
            {15, { name = "fishing_bike", max = 1 }, 2},
            {35, { name = "fishing_seaweed", max = 5 }, 1},
            {10, { name = "fishing_boot", max = 1 }, 3},
            {2, { name = "fishing_chest", max = 1 }, 4},
            {5, { name = "fishing_oil", max = 1 }, 4},
        }
    elseif zone == 2 or zone == 3 then
        return {
            {35, { name = "fishing_grasscarp", max = 1 }, 1},
            {30, { name = "fishing_chub", max = 1 }, 1},
            {15, { name = "fishing_rainbowtrout", max = 1 }, 3},
            {20, { name = "fishing_seaweed", max = 5 }, 1},
    ...
    elseif zone == 4 then
        return {
            {20, { name = "fishing_kelp", max = (usingNet and 4 or 1) }, 2},
            {20, { name = "fishing_bike", max = 1 }, 2},
            {15, { name = "fishing_boot", max = 1 }, 3},
            {40, { name = "fishing_seaweed", max = 5 }, 1},
            {5, { name = "fishing_oil", max = 1 }, 4},
    ...
    elseif zone == 5 then
        return {
            ...
            {20, { name = "fishing_bass", max = (usingNet and 5 or 1) }, 1},
