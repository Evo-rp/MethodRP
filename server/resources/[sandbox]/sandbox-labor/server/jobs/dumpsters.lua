				...
				if data and _searchedDumpsters[_dumpsterId] == nil then
					...
					if _found then
						if _PlayerRep >= 8 then
							Loot:CustomWeightedSetWithCountAndModifier(_dumpsterLoot.high, char:GetData("SID"), 1, 1, false)
							Loot:CustomWeightedSetWithCountAndModifier(_dumpsterLoot.medium, char:GetData("SID"), 1, 1, false)
							Loot:CustomWeightedSetWithCountAndModifier(_dumpsterLoot.low, char:GetData("SID"), 1, 1, false)
