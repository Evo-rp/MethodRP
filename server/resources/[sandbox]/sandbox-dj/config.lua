...
Config = {
	...
	Locations = {
		...
		{ -- Bahama Mama DJ Booth
			...
			DefaultVolume = 0.1, -- 0.01 is lowest, 1.0 is max
			radius = 45, -- The radius of the sound from the booth
			coords = vector3(-1376.805, -607.623, 31.31986), -- Where the booth is located
		},
		{ -- Bakery
			job = "public", -- Set this to required job role
			enableBooth = true, -- option to disable rather than deleting code
		...
		{ -- Pawnshop
			...
			DefaultVolume = 0.1, -- 0.01 is lowest, 1.0 is max
			radius = 10, -- The radius of the sound from the booth
			coords = vector3(171.791, -1323.887, 29.683), -- Where the booth is located
		},
		{ -- Last Train
			job = "public", -- Set this to required job role
			enableBooth = true, -- option to disable rather than deleting code
		...
		},
		{
			...
			DefaultVolume = 0.05,
			radius = 30,
			coords = vector3(91.035, 6516.935, 34.972),
			soundLoc = vector3(71.707, 6512.771, 36.324),
			prop = `prop_radio_01`,
			heading = 331.488,
		},
	},
