...
AddEventHandler("Characters:Client:Spawn", function()
	...
	Blips:Add("minty_customs", "RPM", vector3(90.975, 6530.663, 39.771), 544, 43, 1.0, 2, 11)
end)
...
AddEventHandler("Businesses:Client:Startup", function()
	...
	Targeting.Zones:AddBox("minty_customs-clockinoff", "chess-clock", vector3(68.89, 6504.34, 31.26), 2.8, 2, {
		heading = 315,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 32.46,
