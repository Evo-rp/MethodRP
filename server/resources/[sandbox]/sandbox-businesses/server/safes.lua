AddEventHandler("Businesses:Server:Startup", function()
	...
	Inventory.Poly:Create({
		...
		data = {
			...
			inventory = {
				invType = 139,
				owner = "lostmc_storage_safe",
			},
		},
	})

	Inventory.Poly:Create({
		id = "minty_customs_storage_safe",
		type = "box",
		coords = vector3(101.93, 6526.09, 34.87),
		length = 1.0,
		width = 1.0,
		options = {
			heading = 315,
		...
		data = {
			business = "minty_customs",
			inventory = {
				invType = 170,
				owner = "minty_customs_storage_safe",
			},
		},
	})

	Inventory.Poly:Create({
		id = "minty_customs_storage_safe2",
		type = "box",
		coords = vector3(85.28, 6529.36, 34.87),
		length = 1.0,
		width = 1.0,
		options = {
			heading = 315,
		...
		data = {
			...
			inventory = {
				invType = 170,
				owner = "minty_customs_storage_safe2",
			},
		},
	})
end)
