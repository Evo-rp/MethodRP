					...
					<div>
						<List className={classes.data}>
							...
							<ListItem>
								<ListItemText
									primary="Body"
									secondary={GenerateEngineBodyDiagnostics(car.Damage?.Body)}
								/>
							</ListItem>
							<ListItem>
								<ListItemText
									primary="Engine"
									secondary={GenerateEngineBodyDiagnostics(car.Damage?.Engine)}
								/>
							</ListItem>
									...
									<ListItem key={part}>
										<ListItemText
											primary={part
												...
												.join(' ')}
											secondary={GeneratePartsDiagnostics(car.DamagedParts[part])}
										/>
									</ListItem>
								);
							})}
