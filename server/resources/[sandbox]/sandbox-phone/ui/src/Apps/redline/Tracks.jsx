			...
			>
				{Boolean(selected) && (
					<>
						...
						<FormControl style={{width: "100%"}} className={classes.creatorInput}>
							<InputLabel id="class">Vehicle Class Limits</InputLabel>
							<Select
								labelId="class"
								id="class-select"
