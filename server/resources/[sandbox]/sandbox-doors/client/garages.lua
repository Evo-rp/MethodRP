function CreateGaragePolyZones()
	...
	Polyzone.Create:Box("doors_minty_customs_garage_1", vector3(60.73, 6504.64, 31.26), 20.2, 10, {
		heading = 315,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 34.26,
	}, {
		door_garage_id = "minty_customs_garage_2",
	})

	Polyzone.Create:Box("doors_minty_customs_garage_2", vector3(65.83, 6532.92, 31.26), 24.4, 8.0, {
		heading = 225,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 34.26,
	}, {
		door_garage_id = "minty_customs_garage_1",
	})

	Polyzone.Create:Box("doors_minty_customs_paintbooth_1", vector3(91.94, 6524.51, 31.26), 9.4, 5, {
		heading = 45,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 33.26,
	}, {
		door_garage_id = "minty_customs_paintbooth_1",
	})

	Polyzone.Create:Box("doors_minty_customs_paintbooth_2", vector3(95.06, 6528.96, 31.26), 9.4, 5, {
		heading = 45,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 33.26,
	}, {
		door_garage_id = "minty_customs_paintbooth_2",
	})

	Polyzone.Create:Box("doors_minty_customs_gate_1", vector3(99.0, 6571.7, 31.26), 23.8, 10, {
		heading = 315,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 34.26,
	}, {
		door_garage_id = "minty_customs_gate_1",
	})

	Polyzone.Create:Box("doors_minty_customs_gate_2", vector3(16.69, 6539.55, 31.26), 23.8, 10, {
		heading = 45,
		--debugPoly=true,
		minZ = 30.26,
		maxZ = 33.26,
	}, {
		door_garage_id = "minty_customs_gate_2",
	})
end
