...
addDoorsListToConfig({
	...
	--[[
		Mt Zonah 3 Garage Lobby
	]]
	--

	{
		id = "mt_zonah_garage_lobby_1",
		model = 734304936,
		coords = vector3(-496.29, -340.15, 35.43),
		locked = true,
		--autoRate = 6.0,
		special = true,
		restricted = staffOnlyStrictDoorPermissions,
	...
	{
		id = "mt_zonah_garage_lobby_2",
		model = 734304936,
		coords = vector3(-495.76, -336.11, 35.43),
		locked = true,
		--autoRate = 6.0,
		special = true,
		restricted = staffOnlyStrictDoorPermissions,
	...
	{
		id = "mt_zonah_garage_lobby_3",
		model = 734304936,
		coords = vector3(-495.22, -332.06, 35.43),
		locked = true,
		--autoRate = 6.0,
		special = true,
		restricted = staffOnlyStrictDoorPermissions,
