			...
			while holdingTargeting do
				...
				if hitting then
					...
					if entityType == 1 then
						...
						if IsPedAPlayer(entity) and (#(pedCoords - entityCoords) <= 3.0) and not IsPedInAnyVehicle(GLOBAL_PED) then
					...
					elseif entityType == 2 and NetworkGetEntityIsNetworked(entity) and not IsPedInAnyVehicle(GLOBAL_PED) then
