...
Config.EmoteNaming = {
	["regular"] = {
		...
		["doggo"] = {
			["name"] = "Dog Emotes",
			["emotes"] = {
				{ "dogdown", "(Dog) Lay Down" },
				{ "dogbark", "(Dog) Bark" },
				{ "dogsit", "(Dog) Sit" },
				{ "dogitch", "(Dog) Itch" },
				{ "dogattention", "(Dog) Draw Attention" },
				{ "dogattack", "(Dog) Attack" },
				{ "dogtaunt", "(Dog) Taunt" },
				{ "dogtaunt2", "(Dog) Taunt 2" },
				{ "dogbeg", "(Dog) Beg" },
				{ "dogpaw", "(Dog) Paw" },
				{ "receivepets", "(Dog) Receive Pets" },
				{ "dogpee", "(Dog) Pee" },
				{ "peeleft", "(Dog) Pee Left" },
				{ "peeright", "(Dog) Pee Right" },
				{ "dump", "(Dog) Dump" },
				{ "dogplaydead", "(Dog) Play Dead" },
				{ "dogsitcar", "(Dog) Sit in Car" },
				{ "dogalert", "(Dog) Alert barking" },
				{ "dogpickup", "(Dog) Pick Up" },
				{ "dogdrop", "(Dog) Drop" },
				{ "doghelmet", "(Dog) Wear Helmet" },
				{ "doghat", "(Dog) Wear Hat" },
				{ "dogswim", "(Dog) Dog Swim" },
				{ "doghat2", "(Dog) Wear Hat 2" },
				{ "doghat3", "(Dog) Wear Hardhat" },
				{ "dogglasses", "(Dog) Wear Glasses" },
				{ "dogglasses2", "(Dog) Wear Glasses 2" },
				{ "dogglasses3", "(Dog) Wear Glasses 3" },
				{ "dogshoe", "(Dog) Hold Shoe" },
				{ "dogboot", "(Dog) Hold Boot" },
				{ "dogknife", "(Dog) Hold Knife" },
				{ "dogrose", "(Dog) Hold Rose" },
				{ "dogsandwich", "(Dog) Hold Sandwich" },
				{ "dogwater", "(Dog) Hold Water" },
				{ "dogwhiskey", "(Dog) Hold Whiskey" },
				{ "dogbeer", "(Dog) Hold Beer" },
				{ "dogbrick", "(Dog) Hold Brick" },
				{ "dogcash", "(Dog) Hold Cash" },
				{ "dogbook", "(Dog) Hold Book" },
				{ "dogmedbag", "(Dog) Hold Medbag" },
				{ "dognews", "(Dog) Hold Newspaper" },
				{ "dogball", "(Dog) Hold Ball" },
				{ "dogsteak", "(Dog) Hold Steak" },
				{ "dogmic", "(Dog) Hold Microphone" },
				{ "dogstungun", "(Dog) Hold Stungun" },
				{ "dogball2", "(Dog) Hold baseball" },
				{ "dogball3", "(Dog) Hold Soccer ball" },
				{ "dogball4", "(Dog) Hold Football" },
				{ "dogball5", "(Dog) Hold Hackysack" },
				{ "dogdonut", "(Dog) Hold Donut" },
				{ "doghotdog", "(Dog) Hold Hotdog" },
				{ "dogphone", "(Dog) Hold Phone" },
				{ "dogtablet", "(Dog) Hold Tablet" },
				{ "dogradio", "(Dog) Hold Radio" },
				{ "dogpaper", "(Dog) Hold Paper ball" },
				{ "dogbear", "(Dog) Hold Bear" },
				{ "dogbear2", "(Dog) Hold Clean Bear" },
				{ "doglawnchair", "(Dog) Lawnchair" },
				{ "dogshred", "(Dog) Shred something" },
				{ "dogidle", "(Dog) Idle sit/lay" },
			},
		},
