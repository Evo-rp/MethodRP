        ...
        for k, v in pairs(partNames) do
            if vehDamage and vehDamage[k] then
                ...
                for partId, part in pairs(_mechanicItemsToParts) do
                    if part.part == k and ((not requiresHighGradeParts and part.regular) or (requiresHighGradeParts and part.hperformance)) then
                        partData = part
                ...
                if partData and partData.item then
                    ...
                    if itemData and requiredToFix > 0 then
                        table.insert(menu.main.items, {
                            ...
                            description = string.format("Repair To Full - This Requires %sx %s", requiredToFix, itemData.label),
