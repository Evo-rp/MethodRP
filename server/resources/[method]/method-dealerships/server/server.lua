...
function RetrieveComponents()
    ...
    Dealerships = exports['method-base']:FetchComponent('Dealerships')
    ...
    Default = exports['method-base']:FetchComponent('Default')
    Chat = exports['method-base']:FetchComponent('Chat')
    MDT = exports['method-base']:FetchComponent('MDT')
end

AddEventHandler('Core:Shared:Ready', function()
    exports['method-base']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['method-base']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
                ...
                if vehEnt.state.VIN and vehEnt.state.Owned and vehEnt.state.Make then
                    if not vehEnt.state.Donator and vehEnt.state.Value and type(vehEnt.state.Value) == "number" and vehEnt.state.Value > 0 then
                        ...
                        if vehModel then
                            ...
                            local remainingLoan = Loans:HasRemainingPayments("vehicle", vehEnt.state.VIN, 30)
                            ...
                            if not remainingLoan then
                                ...
                                cb(false, "Vehicle Still Has Remaining Loan Payments or Has Not Been Held for Longer than 30 Days")
                            end
                        else
