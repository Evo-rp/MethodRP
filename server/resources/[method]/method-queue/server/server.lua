...
QUEUE.Connect = function(self, source, playerName, setKickReason, deferrals)
	...
	Citizen.CreateThread(function()
		...
		if plyr.State == States.QUEUED then
			...
			Log(print(Config.Strings.Grace, plyr.Name, os.date("%I:%M:%S %p", plyr.Grace)))
			Data.Queue[pos] = plyr
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Queue", QUEUE)
end)

AddEventHandler("Queue:Shared:DependencyUpdate", RetrieveComponents)
function RetrieveComponents()
	c = exports["method-base"]:FetchComponent("Config")
	Database = exports["method-base"]:FetchComponent("Database")
	WebAPI = exports["method-base"]:FetchComponent("WebAPI")
	Punishment = exports["method-base"]:FetchComponent("Punishment")
	Queue = exports["method-base"]:FetchComponent("Queue")
	Convar = exports["method-base"]:FetchComponent("Convar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Queue", {
		"Config",
		"Database",
		"WebAPI",
		"Punishment",
...
Citizen.CreateThread(function()
	...
	if not exports["method-base"]:FetchComponent("WebAPI").Enabled then
