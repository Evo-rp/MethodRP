...
function RetrieveComponents()
	...
	Scenes = exports["method-base"]:FetchComponent("Scenes")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Scenes", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["method-base"]:FetchComponent("Logger"):Critical("Scenes", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Scenes", _SCENES)
end)
