...
function RetrieveComponents()
	...
	Visuals = exports["method-base"]:FetchComponent("Visuals")
	RegisterChatCommands()
end

AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Visuals", {
		"Chat",
		"Visuals",
	}, function(error)
		if #error > 0 then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Visuals", VISUALS)
end)
