...
function RetrieveComponents()
	...
	Radar = exports["method-base"]:FetchComponent("Radar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Police", {
		"Database",
		"Middleware",
		"Callbacks",
		"Logger",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Police", POLICE)
end)

RegisterNetEvent("Police:Server:Cuff", function()
	local src = source
	local char = Fetch:CharacterSource(src)
	if char ~= nil and Player(src).state.onDuty == "police" then
