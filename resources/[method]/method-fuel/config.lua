Config = {
	...
	FuelStations = {
		...
		{ -- Innocence Blvd
			center = vector3(910.38, -1681.57, 51.14),
			length = 11.0,
			width = 11.0,
			heading = 356,
			minZ = 49.54,
		...
		{ -- Central LS #1
			center = vector3(313.53, -1464.84, 46.51),
			length = 11.0,
			width = 11.0,
			heading = 50,
			minZ = 44.91,
		...
		{ -- Central LS #2
			center = vector3(299.52, -1453.38, 46.51),
			length = 11.0,
			width = 11.0,
			heading = 50,
			minZ = 44.91,
		...
		{ -- Merryweather Helipad
			center = vector3(478.22, -3369.82, 6.07),
			length = 18.6,
			width = 18.0,
			heading = 90,
			minZ = 4.47,
		...
		{ -- LSIA #2 Helipad
			center = vector3(-1146.18, -2864.52, 13.95),
			length = 18.6,
			width = 18.0,
			heading = 60,
			minZ = 12.35,
		...
		{ -- LSIA #3 Helipad
			center = vector3(-1178.23, -2845.69, 13.95),
			length = 18.6,
			width = 18.0,
			heading = 60,
			minZ = 12.35,
		...
		{
			center = vector3(964.09, -1831.45, 21.04),
			length = 10.0,
			width = 10.0,
			heading = 357,
			--debugPoly=true,
