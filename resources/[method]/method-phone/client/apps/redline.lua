...
function StartRace()
	...
	Citizen.CreateThread(function()
		...
		while _activeRace ~= nil and _loggedIn do
			...
			if (ghosting and not myveh) or (cp ~= nil and next(cp) ~= nil and dist > 250.0 and ghosting and _activeRace.phasing) then
				UnGhostPlayer()
			elseif not ghostingEnded and not ghosting and _activeRace ~= nil and dist <= 250.0 and myveh > 0 then
				GhostPlayer()
			end
