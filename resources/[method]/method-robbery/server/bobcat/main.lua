				...
				if actualData.data.type == data.type then
					...
					if char ~= nil then
						...
						if data.id == 1 then
							...
							if t[schem] ~= nil then
								Inventory:AddItem(char:GetData("SID"), t[schem], 1, {}, 1)
							else
								...
								if t[schem] ~= nil then
									Inventory:AddItem(char:GetData("SID"), _bobcatCombined[math.random(#_bobcatCombined)], 1, {}, 1)
								end
							end
						elseif data.id == 4 then
							...
							if t[schem] ~= nil then
								...
								Inventory:AddItem(char:GetData("SID"), _bobcatAttchSchems[math.random(#_bobcatAttchSchems)], 1, {}, 1)
							end
						end
