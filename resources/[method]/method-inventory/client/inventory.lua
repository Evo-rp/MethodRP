...
AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Inventory", {
		"Callbacks",
		"Inventory",
		"Utils",
		"Notification",
...
INVENTORY = {
	...
	IsEnabled = function(self)
		return _startup and not _disabled and not _openCd and not _timedCd and not Hud:IsDisabled()
	end,
	Open = {
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Inventory", INVENTORY)
end)
