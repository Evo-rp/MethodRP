...
function RetrieveComponents()
	...
	Wardrobe = exports["method-base"]:FetchComponent("Wardrobe")
	...
	InfoOverlay = exports["method-base"]:FetchComponent("InfoOverlay")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["method-base"]:RequestDependencies("Properties", {
		"Callbacks",
		"Inventory",
		"Logger",
		"Utils",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["method-base"]:RegisterComponent("Properties", PROPERTIES)
end)
