						...
						if data.loan and data.time and data.deposit then
												...
												Billing:Create(targetChar:GetData('Source'), 'Dynasty 8', downPayment, string.format('Property Downpayment for %s', prop.label), function(wasPayed, withAccount)
													if wasPayed then
														...
														if loanSuccess then
															...
															Phone.Notification:Add(source, "Property Sale Successful", string.format("(Loan Sale) %s was sold to %s %s.", prop.label, targetChar:GetData('First'), targetChar:GetData('Last')), os.time(), 7000, _phoneApp, {})
														...
														Phone.Notification:Add(source, "Property Sale Failed", string.format("(Loan Sale) The downpayment failed when trying to sell %s to %s %s.", prop.label, targetChar:GetData('First'), targetChar:GetData('Last')), os.time(), 7000, _phoneApp, {})
													end
							...
							Billing:Create(targetChar:GetData('Source'), 'Dynasty 8', prop.price, 'Purchase of ' .. prop.label, function(wasPayed, withAccount)
								if wasPayed then
									...
									Phone.Notification:Add(source, "Property Sale Successful", string.format("(Cash Sale) %s was sold to %s %s.", prop.label, targetChar:GetData('First'), targetChar:GetData('Last')), os.time(), 7000, _phoneApp, {})
									...
									Phone.Notification:Add(source, "Property Sale Failed", string.format("(Cash Sale) The bank transfer failed when trying to sell %s to %s %s.", prop.label, targetChar:GetData('First'), targetChar:GetData('Last')), os.time(), 7000, _phoneApp, {})
								end
								_selling[data.property] = nil
							end)
						end
									...
									SendPendingPropertyTransfer(newOwner:GetData("Source"), false, {
										...
										if accepted and stateId == newOwner:GetData("SID") then
											if Properties.Commerce:Buy(prop.id, {
												...
												Phone.Notification:Add(source, "Property Transfer Successful", "The property transfer was successful.", os.time(), 7000, _phoneApp, {})
												...
												Phone.Notification:Add(source, "Property Transfer Failed", "The property transfer failed.", os.time(), 7000, _phoneApp, {})
											end
										else
											Phone.Notification:Add(source, "Property Transfer Failed", "The new owner declined the transfer.", os.time(), 7000, _phoneApp, {})
										end
									end)
								else
									Phone.Notification:Add(source, "Property Transfer Failed", "The owner declined the transfer.", os.time(), 7000, _phoneApp, {})
								end
							end)
