function CreateGaragePolyZones()
	...
	Polyzone.Create:Box("doors_minty_customs_garage_1", vector3(151.23, 6390.33, 31.18), 24.0, 10, {
		heading = 30,
		--debugPoly=true,
		minZ = 30.18,
		maxZ = 34.18,
	...
	Polyzone.Create:Box("doors_minty_customs_garage_2", vector3(160.19, 6395.02, 31.18), 24.0, 10, {
		heading = 30,
		--debugPoly=true,
		minZ = 30.18,
		maxZ = 34.18,
