...
export default () => {
    ...
    return (
        <Slide direction="right" in={showing} timeout={500} mountOnEnter unmountOnExit>
            <div className={classes.wrapper}>
            	<div className={classes.wrapperContainer}>
					{info[0] && info[0].Name == "hunting_map_dark" && (
						<div className={classes.imageBG} style={{backgroundImage: `url(${HuntingMapDark})`  }} />
					)}
					{info[0] && info[0].Name == "hunting_map_light" && (
						<div className={classes.imageBG} style={{backgroundImage: `url(${HuntingMapLight})`  }} />
					)}
					{info[0] && info[0].Name == "vanityitem" && (
						<div className={classes.imageBG} style={{backgroundImage: `url(${info[0].MetaData.CustomItemImage})`  }} />
					)}
				</div>
            </div>
        </Slide>
